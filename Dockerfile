FROM registry.redhat.io/ansible-automation-platform-26/ansible-dev-tools-rhel9:latest@sha256:d783b3fa3daea76915743db173232ae806c27df829c235758f31fead509cb185 AS builder
