...
The [molecule/README.md](https://github.com/securesign/artifact-signer-ansible/blob/release-1.3/molecule/README.md) file has instructions on testing the deployment on a virtual machine (VM).
...
You can find the license information within the [LICENSE](https://github.com/securesign/artifact-signer-ansible/blob/release-1.3/LICENSE) file.
