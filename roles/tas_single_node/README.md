...
| private_keys | List of private keys for use within rekor. | dict of 'private_keys' options | no |  |
| public_keys | List of public keys for use within rekor. | dict of 'public_keys' options | no |  |
