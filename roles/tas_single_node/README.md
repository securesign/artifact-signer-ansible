...
| tas_single_node_rekor_server_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "rekor-server" volume. This can be used to customize the options when creating the "rekor-server" volume. | str |  |
| tas_single_node_trillian_mysql_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "trillian-mysql" volume. This can be used to customize the options when creating the "trillian-mysql" volume. | str |  |
| tas_single_node_rekor_redis_storage_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "rekor-redis-storage" volume. This can be used to customize the options when creating the "rekor-redis-storage" volume. | str |  |
| tas_single_node_redis_backfill_storage_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "redis-backfill-storage" volume. This can be used to customize the options when creating the "redis-backfill-storage" volume. | str |  |
| tas_single_node_tuf_repository_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "tuf-repository" volume. This can be used to customize the options when creating the "tuf-repository" volume. | str |  |
| tas_single_node_tuf_signing_keys_create_args | Additional arguments to pass to the `podman volume create` command specifically for the "tuf-signing-keys" volume. This can be used to customize the options when creating the "tuf-signing-keys" volume. | str |  |
